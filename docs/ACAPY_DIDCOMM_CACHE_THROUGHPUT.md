...
Full investigation (isolation matrix, TTL/LRU hardening, multi-replica scaling, inbound appendix): see [`ACAPY_THROUGHPUT_REPORT.md`](https://github.com/DigiCred-Holdings/owl-akrida/blob/benchmark/basic-msg-10k/docs/ACAPY_THROUGHPUT_REPORT.md) on the `benchmark/basic-msg-10k` branch.
